...
> [Limits](https://github.com/kbwumin13-sudo/web-gpt/discussions/309)。Token 上下文上限取决于
...
- 公开发布包目前只提供 macOS 13+（arm64/x64）。内部 CI 仍保留 Windows 和 Linux 兼容性检查；
  依赖账户的浏览器与 MCP 流程使用单独的[发布验证](docs/release-validation.md)。
