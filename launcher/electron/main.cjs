...
const GITHUB_URL = "https://github.com/kbwumin13-sudo/web-gpt";
...
const ALLOWED_EXTERNAL_URLS = new Set([GITHUB_URL, DEVELOPER_URL, X_URL, CONNECTORS_URL, TUNNELS_URL, KEYS_URL]);
