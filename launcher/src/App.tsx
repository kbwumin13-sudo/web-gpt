  ...
  return (
    <span className={`brand-mark${small ? " is-small" : ""}`}>
      <svg aria-hidden="true" viewBox="0 0 24 24">
        <path d="M4.2 8.2 12 3.7l7.8 4.5v9L12 21.7l-7.8-4.5v-9Z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="1.5" />
        <path d="m7.3 10 4.7 2.7 4.7-2.7M12 12.7v5.1M7.3 10v4.1l4.7 2.7 4.7-2.7V10" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      </svg>
    </span>
  );
}
