...
test("checksums and release URLs bind the exact expected asset", () => {
  ...
  assert.equal(
    validateReleaseAssetUrl(
      "https://github.com/kbwumin13-sudo/web-gpt/releases/download/v1.2.0/launcher.zip",
      "1.2.0",
      "launcher.zip",
    ),
    "https://github.com/kbwumin13-sudo/web-gpt/releases/download/v1.2.0/launcher.zip",
          ...
          assets: [
            {
              ...
              browser_download_url: "https://github.com/kbwumin13-sudo/web-gpt/releases/download/v1.2.0/codex-web-gpt-1.2.0-linux-x64.AppImage",
            },
            {
              name: "checksums.txt",
              browser_download_url: "https://github.com/kbwumin13-sudo/web-gpt/releases/download/v1.2.0/checksums.txt",
            },
          ],
        };
      },
