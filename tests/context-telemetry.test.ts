...
test("turns that never conclude do not accumulate without bound", () => {
  ...
  // Totals are unaffected by forgetting; only the ability to correct a turn later is.
  expect(chatGptContextTelemetrySnapshot()).toMatchObject({ omitted_turns: 400, omitted_records: 400 });
